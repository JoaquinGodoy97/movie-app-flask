...
def go_to_first_page_results(search_result, current_page):
    return redirect(url_for('results.results_search_list', search_result=search_result, current_page=current_page))

def go_to_next_page(search_result, current_page):
    return redirect(url_for('results.results_search_list', search_result=search_result, current_page=current_page))

def go_to_prev_page(search_result, current_page):
    return redirect(url_for('results.results_search_list', search_result=search_result, current_page=current_page))
...
def password_reminder_alert(user, password):
